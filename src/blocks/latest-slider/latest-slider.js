...
let sliderProduct = function () {
    let sliderMain = $('.latest-slider');

    sliderMain.each(function (index, item) {
        let sliderNavigate = $(item).next(".latest-slider__navigate");
        $(item).slick({
            dots: false,
            infinite: true,
            slidesToShow: 5,
